...
describe("Pruebas unitarias de Users", () => {
	...
	test("POST /api/user -> crear un usuario", async () => {
		const response = await request(app)
			...
			.set(
				"Authorization",
				`Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiYWRtaW4iLCJwYXNzd29yZCI6IioqKioqKioiLCJyb2wiOiJPd25lciIsImlhdCI6MTc1MDEwMDA3M30.8t52wDO-SuKLEnGqhSl5TqCTkVlugzTAGW9sGzgs5jA`,
			)
			.send({
				user: {
